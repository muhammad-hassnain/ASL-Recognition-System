...
from model_5 import DenseNet121
...
Plot_Saving_Directory = 'plots_model_5'
...
model = MobileNetV2ConvNet()
model.load_state_dict(torch.load('model_4.weights'))  # Load the saved model weights
model.to(device)
model.eval()  # Set the model to evaluation mode

# outputs = train_net(model, train_dataloader, test_dataloader)
# torch.save(model.state_dict(), 'model_4.weights')
