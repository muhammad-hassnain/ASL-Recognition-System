...
from model_3 import VGG16ConvNet
...
Plot_Saving_Directory = 'plots_model_3'
...
model = VGG16ConvNet()
model.load_state_dict(torch.load('model_3.weights'))  # Load the saved model weights
model.to(device)
model.eval()  # Set the model to evaluation mode

# outputs = train_net(model, train_dataloader, test_dataloader)
# torch.save(model.state_dict(), 'model_3.weights')
